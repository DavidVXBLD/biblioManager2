 ...
 * Clients
 *
 * @ORM\Table(name="clients", uniqueConstraints={@ORM\UniqueConstraint(name="mail", columns={"mail"}), @ORM\UniqueConstraint(name="phone", columns={"phone"})})
 * @ORM\Entity
 */
class Clients
{
     ...
     * @var string
     *
     * @ORM\Column(name="mail", type="string", length=65, nullable=false)
     */
    private $mail;
