 ...
 */
final class Version20220203125610 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE books CHANGE title title VARCHAR(100) NOT NULL COLLATE `utf8mb4_general_ci`, CHANGE author author VARCHAR(100) NOT NULL COLLATE `utf8mb4_general_ci`, CHANGE summary summary VARCHAR(400) NOT NULL COLLATE `utf8mb4_general_ci`, CHANGE category category VARCHAR(50) NOT NULL COLLATE `utf8mb4_general_ci`');
        $this->addSql('ALTER TABLE books_clients DROP FOREIGN KEY FK_9BAA8E77DD8AC20');
        $this->addSql('ALTER TABLE books_clients DROP FOREIGN KEY FK_9BAA8E7AB014612');
        ...
        $this->addSql('ALTER TABLE clients CHANGE first_name first_name VARCHAR(50) NOT NULL COLLATE `utf8mb4_general_ci`, CHANGE last_name last_name VARCHAR(50) NOT NULL COLLATE `utf8mb4_general_ci`, CHANGE adress adress VARCHAR(95) NOT NULL COLLATE `utf8mb4_general_ci`, CHANGE city city VARCHAR(35) NOT NULL COLLATE `utf8mb4_general_ci`, CHANGE mail mail VARCHAR(65) NOT NULL COLLATE `utf8mb4_general_ci`, CHANGE phone phone VARCHAR(15) NOT NULL COLLATE `utf8mb4_general_ci`');
    }
}
